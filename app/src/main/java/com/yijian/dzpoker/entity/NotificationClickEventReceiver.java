...
import com.yijian.dzpoker.activity.club.ChatActivity;
    ...
    public void onEvent(NotificationClickEvent notificationClickEvent) {
        ...
        if (msg != null) {
            ...
            if (type == ConversationType.single) {
                ...
                notificationIntent.putExtra(DzApplication.TARGET_ID, targetId);
                notificationIntent.putExtra(DzApplication.TARGET_APP_KEY, appKey);
            } else {
                conv = JMessageClient.getGroupConversation(Long.parseLong(targetId));
                notificationIntent.putExtra(DzApplication.GROUP_ID, Long.parseLong(targetId));
            }
            notificationIntent.putExtra(DzApplication.CONV_TITLE, conv.getTitle());
