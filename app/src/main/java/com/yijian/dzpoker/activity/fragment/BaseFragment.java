...
//		View v = inflater.inflate(R.layout.messages_layout, container, false);
    ...
    public static BaseFragment newInstance(Context context,String tag){
        ...
        if(TextUtils.equals(tag, Constant.FRAGMENT_FLAG_MAIN)){
            baseFragment = new MainFragment();
        }else if(TextUtils.equals(tag, Constant.FRAGMENT_FLAG_GAME)){
            baseFragment = new GameFragment();
        }else if(TextUtils.equals(tag, Constant.FRAGMENT_FLAG_CLUB)){
            baseFragment = new ClubFragment();
