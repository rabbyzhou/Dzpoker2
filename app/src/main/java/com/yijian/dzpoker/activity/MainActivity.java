...
/*	private MessageFragment messageFragment;
    ...
    public void onBottomPanelClick(int itemId) {
        ...
        String tag = "";
        if((itemId & Constant.BTN_FLAG_MAIN) != 0){
            tag = Constant.FRAGMENT_FLAG_MAIN;
        }else if((itemId & Constant.BTN_FLAG_GAME) != 0){
            tag = Constant.FRAGMENT_FLAG_GAME;
        }else if((itemId & Constant.BTN_FLAG_CLUB) != 0){
            tag = Constant.FRAGMENT_FLAG_CLUB;
