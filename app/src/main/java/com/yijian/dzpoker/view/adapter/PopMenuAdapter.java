 ...
 */
public class PopMenuAdapter extends BaseListAdapter<City, PopMenuAdapter.ViewHolder> {

    private OnRecordSelectListener mListener;


    public PopMenuAdapter(Context context, OnRecordSelectListener listener) {
        super(context);
        mListener=listener;
    }
