...
package com.yijian.dzpoker.baselib.widget.switchbutton.facebook.rebound.ui;
...
import com.yijian.dzpoker.baselib.widget.switchbutton.facebook.rebound.OrigamiValueConverter;
...
import com.yijian.dzpoker.baselib.widget.switchbutton.facebook.rebound.SpringConfigRegistry;
import com.yijian.dzpoker.baselib.widget.switchbutton.facebook.rebound.SpringListener;
...
import static com.yijian.dzpoker.baselib.widget.switchbutton.facebook.rebound.ui.Util.dpToPx;
...
public class SpringConfiguratorView extends FrameLayout {
  ...
  private View generateHierarchy(Context context) {
    ...
    params = Util.createLayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, dpToPx(300, resources));
    root.setLayoutParams(params);
      ...
      root.addView(container);
        ...
        container.addView(linearLayout);
          ...
          linearLayout.addView(seekWrapper);
            ...
            params = Util.createLayoutParams(dpToPx(50, resources), ViewGroup.LayoutParams.MATCH_PARENT);
      ...
      params = Util.createLayoutParams(dpToPx(60, resources), dpToPx(40, resources));
